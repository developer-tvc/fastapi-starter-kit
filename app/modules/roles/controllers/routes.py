...
@router.get("/permissions", response_model=APIResponse[list[schemas.PermissionResponse]])
...
@router.put("/permissions", response_model=APIResponse[schemas.PermissionUpdateResponse])
...
@router.delete("/permissions", response_model=APIResponse[schemas.PermissionDeleteResponse])
...
@router.delete("/unassign_permission", response_model=APIResponse[schemas.AssignPermission])
